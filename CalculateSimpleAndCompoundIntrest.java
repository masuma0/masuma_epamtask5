...
public class CalculateSimpleAndCompoundIntrest {
	Logger log = Logger.getLogger(CalculateSimpleAndCompoundIntrest.class.getName());
	...
	public void inputDetails() { 
		try (Scanner sc = new Scanner(System.in)){
			Boolean flag = true;
			CalculateSimpleAndCompoundIntrest calculate = new CalculateSimpleAndCompoundIntrest();
			while(flag) {
